...
import palmbeachbanner from '../../images/Areas/delrayBeachIMG.jpeg'
...
const DelrayBeach = () => {
    ...
    return (
        <div className="palmBeachContainer">
            ...
            <div className="search" ><a href="/listing-results/delray beach">SEARCH DELRAY BEACH LISTINGS</a></div>
            <Footer />
        </div>
    );
};
