...
import palmbeachbanner from '../../images/Areas/boca.jpeg'
...
const BocaRaton = () => {
    ...
    return (
        <div className="palmBeachContainer">
            ...
            <div className="flex-wrapper-locations">
                ...
                <div className="introduction">
                    <div className="intro-content">
                        <a href="https://www.thepalmbeaches.com/"><h1 className="title">WELCOME TO BOCA RATON</h1></a>
            ...
            <div className="search" ><a href="/listing-results/boca raton">SEARCH BOCA RATON LISTINGS</a></div>
            <Footer />
        </div>
    );
};
