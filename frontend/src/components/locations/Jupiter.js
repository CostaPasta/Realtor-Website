...
import palmbeachbanner from '../../images/Areas/jupiter.jpeg'
...
const Jupiter = () => {
    ...
    return (
        <div className="palmBeachContainer">
            ...
            <div className="flex-wrapper-locations">
                ...
                <div className="introduction">
                    <div className="intro-content">
                        <a href="https://www.thepalmbeaches.com/"><h1 className="title">WELCOME TO JUPITER</h1></a>
            ...
            <div className="search" ><a href="/listing-results/jupiter">SEARCH JUPITER LISTINGS</a></div>
            <Footer />
        </div>
    );
};
