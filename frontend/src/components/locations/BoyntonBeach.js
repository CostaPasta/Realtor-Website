...
import palmbeachbanner from '../../images/Areas/boyntonBeachIMG.jpeg'
...
const BoyntonBeach = () => {
    ...
    return (
        <div className="palmBeachContainer">
            ...
            <div className="flex-wrapper-locations">
                ...
                <div className="introduction">
                    <div className="intro-content">
                        <a href="https://www.thepalmbeaches.com/"><h1 className="title">WELCOME TO BOYNTON BEACH</h1></a>
            ...
            <div className="search" ><a href="/listing-results/boynton beach">SEARCH BOYNTON BEACH LISTINGS</a></div>
            <Footer />
        </div>
    );
};
