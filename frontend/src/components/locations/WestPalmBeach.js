...
import palmbeachbanner from '../../images/Areas/downtownwpb.jpeg'
...
const WestPalmBeach = () => {
    ...
    return (
        <div className="palmBeachContainer">
            ...
            <div className="flex-wrapper-locations">
                ...
                <div className="introduction">
                    <div className="intro-content">
                        <a href="https://www.thepalmbeaches.com/"><h1 className="title">WELCOME TO WEST PALM BEACH</h1></a>
            ...
            <div className="search" ><a href="/listing-results/west palm beach">SEARCH WEST PALM BEACH LISTINGS</a></div>
            <Footer />
        </div>
    );
};
